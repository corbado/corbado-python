...
class PasswordManagersApi:
    ...
    def password_manager_list(
        ...
        _param = self._password_manager_list_serialize(
            user_id=user_id,
    ...
    @validate_call
    def password_manager_list_with_http_info(
        self,
        user_id: Annotated[StrictStr, Field(description="ID of user")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PasswordManagerList]:
        """password_manager_list
    ...
    @validate_call
    def password_manager_list_without_preload_content(
        self,
        user_id: Annotated[StrictStr, Field(description="ID of user")],
        _request_timeout: Union[
            None,
    ...
    def _password_manager_list_serialize(
        self,
        user_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/users/{userID}/passwordManagers',
