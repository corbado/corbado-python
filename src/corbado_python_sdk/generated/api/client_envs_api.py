...
class ClientEnvsApi:
    ...
    def client_env_list(
        ...
        _param = self._client_env_list_serialize(
            user_id=user_id,
    ...
    @validate_call
    def client_env_list_with_http_info(
        self,
        user_id: Annotated[StrictStr, Field(description="Unique identifier of the user. Format: `usr-<number>`. ")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def client_env_list_without_preload_content(
        self,
        user_id: Annotated[StrictStr, Field(description="Unique identifier of the user. Format: `usr-<number>`. ")],
        _request_timeout: Union[
            None,
    ...
    def _client_env_list_serialize(
        self,
        user_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/users/{userID}/clientEnvs',
