...
class ChallengesApi:
    ...
    def challenge_create(
        ...
        _param = self._challenge_create_serialize(
            user_id=user_id,
            challenge_create_req=challenge_create_req,
    ...
    def _challenge_create_serialize(
        self,
        user_id,
        challenge_create_req,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if challenge_create_req is not None:
            _body_params = challenge_create_req
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/users/{userID}/challenges',
    ...
    def challenge_update(
        ...
        :param challenge_update_req: (required)
        :type challenge_update_req: ChallengeUpdateReq
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._challenge_update_serialize(
            user_id=user_id,
            challenge_id=challenge_id,
            challenge_update_req=challenge_update_req,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _challenge_update_serialize(
        self,
        user_id,
        challenge_id,
        challenge_update_req,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if challenge_update_req is not None:
            _body_params = challenge_update_req
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/users/{userID}/challenges/{challengeID}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
