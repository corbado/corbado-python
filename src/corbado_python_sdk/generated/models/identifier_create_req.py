...
class IdentifierCreateReq(BaseModel):
    """
    IdentifierCreateReq
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["identifierType", "identifierValue", "status"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IdentifierCreateReq from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IdentifierCreateReq from a dict"""
        if obj is None:
            return None
