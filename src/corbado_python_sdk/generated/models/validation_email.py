...
class ValidationEmail(BaseModel):
    ...
    domain: StrictStr
    reachable: StrictStr
    disposable: StrictBool
    free: StrictBool
    has_mx_records: StrictBool = Field(alias="hasMxRecords")
    __properties: ClassVar[List[str]] = ["username", "domain", "reachable", "disposable", "free", "hasMxRecords"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ValidationEmail from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ValidationEmail from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "free": obj.get("free"),
            "hasMxRecords": obj.get("hasMxRecords")
        })
        return _obj
