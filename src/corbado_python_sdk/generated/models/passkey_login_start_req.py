...
class PasskeyLoginStartReq(BaseModel):
    """
    ...
    cross_device_authentication_strategy: CrossDeviceAuthenticationStrategy = Field(alias="crossDeviceAuthenticationStrategy")
    process_id: StrictStr = Field(alias="processID")
    __properties: ClassVar[List[str]] = ["userID", "clientInformation", "crossDeviceAuthenticationStrategy", "processID"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PasskeyLoginStartReq from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PasskeyLoginStartReq from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "crossDeviceAuthenticationStrategy": obj.get("crossDeviceAuthenticationStrategy"),
