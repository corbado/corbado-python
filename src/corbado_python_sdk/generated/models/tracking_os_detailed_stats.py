...
class TrackingOSDetailedStats(BaseModel):
    """
    ...
    os_platform: StrictStr = Field(alias="osPlatform")
    cnt: StrictInt
    webauthn: StrictInt
    platform: StrictInt
    conditional_ui: StrictInt
    __properties: ClassVar[List[str]] = ["timePoint", "osName", "osVersion", "osPlatform", "cnt", "webauthn", "platform", "conditional_ui"]

    @field_validator('os_platform')
    def os_platform_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['desktop', 'mobile', 'unknown']):
            raise ValueError("must be one of enum values ('desktop', 'mobile', 'unknown')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TrackingOSDetailedStats from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TrackingOSDetailedStats from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "conditional_ui": obj.get("conditional_ui")
        })
        return _obj
