...
class UserPhoneNumberCreateRspAllOfData(BaseModel):
    """
    UserPhoneNumberCreateRspAllOfData
    """ # noqa: E501
    phone_number_id: StrictStr = Field(alias="phoneNumberID")
    __properties: ClassVar[List[str]] = ["phoneNumberID"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserPhoneNumberCreateRspAllOfData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserPhoneNumberCreateRspAllOfData from a dict"""
        if obj is None:
            return None
