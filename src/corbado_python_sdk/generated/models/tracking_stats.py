...
class TrackingStats(BaseModel):
    ...
    aggregate_visits: StrictInt = Field(alias="aggregateVisits")
    aggregate_webauthn: StrictInt = Field(alias="aggregateWebauthn")
    aggregate_platform: StrictInt = Field(alias="aggregatePlatform")
    aggregate_conditional_ui: StrictInt = Field(alias="aggregateConditionalUi")
    __properties: ClassVar[List[str]] = ["timePoint", "aggregateVisits", "aggregateWebauthn", "aggregatePlatform", "aggregateConditionalUi"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TrackingStats from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TrackingStats from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "aggregateVisits": obj.get("aggregateVisits"),
            "aggregateWebauthn": obj.get("aggregateWebauthn"),
            "aggregatePlatform": obj.get("aggregatePlatform"),
            "aggregateConditionalUi": obj.get("aggregateConditionalUi")
        })
        return _obj
