...
class TrackingOSStats(BaseModel):
    """
    TrackingOSStats
    """ # noqa: E501
    ...
    android: StrictInt
    other: StrictInt
    __properties: ClassVar[List[str]] = ["timePoint", "macos", "windows", "ios", "android", "other"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TrackingOSStats from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TrackingOSStats from a dict"""
        if obj is None:
            return None
