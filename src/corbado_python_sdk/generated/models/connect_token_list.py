...
class ConnectTokenList(BaseModel):
    """
    ConnectTokenList
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConnectTokenList from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in connect_tokens (list)
        _items = []
        if self.connect_tokens:
            for _item_connect_tokens in self.connect_tokens:
                if _item_connect_tokens:
                    _items.append(_item_connect_tokens.to_dict())
            _dict['connectTokens'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConnectTokenList from a dict"""
        if obj is None:
            return None
