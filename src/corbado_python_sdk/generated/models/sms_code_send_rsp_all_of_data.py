...
class SmsCodeSendRspAllOfData(BaseModel):
    """
    SmsCodeSendRspAllOfData
    """ # noqa: E501
    sms_code_id: StrictStr = Field(alias="smsCodeID")
    __properties: ClassVar[List[str]] = ["smsCodeID"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SmsCodeSendRspAllOfData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SmsCodeSendRspAllOfData from a dict"""
        if obj is None:
            return None
