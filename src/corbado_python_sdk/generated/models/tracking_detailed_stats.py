...
class TrackingDetailedStats(BaseModel):
    """
    ...
    webauthn: StrictInt
    platform: StrictInt
    conditional_ui: StrictInt = Field(alias="conditionalUi")
    __properties: ClassVar[List[str]] = ["timePoint", "visits", "webauthn", "platform", "conditionalUi"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TrackingDetailedStats from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TrackingDetailedStats from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "conditionalUi": obj.get("conditionalUi")
        })
        return _obj
