...
class PasskeyLoginFinishReq(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["userID", "assertionResponse", "clientInformation", "processID", "signPasskeyData", "trackingID"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PasskeyLoginFinishReq from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PasskeyLoginFinishReq from a dict"""
        if obj is None:
            return None
