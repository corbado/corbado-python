...
class IdentifierList(BaseModel):
    ...
    paging: Paging
    __properties: ClassVar[List[str]] = ["identifiers", "paging"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IdentifierList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IdentifierList from a dict"""
        if obj is None:
            return None
