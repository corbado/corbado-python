...
class EmailCodeSendRspAllOfData(BaseModel):
    """
    EmailCodeSendRspAllOfData
    """ # noqa: E501
    email_code_id: StrictStr = Field(alias="emailCodeID")
    __properties: ClassVar[List[str]] = ["emailCodeID"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EmailCodeSendRspAllOfData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EmailCodeSendRspAllOfData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "emailCodeID": obj.get("emailCodeID")
        })
        return _obj
