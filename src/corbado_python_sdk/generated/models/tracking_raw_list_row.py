...
class TrackingRawListRow(BaseModel):
    """
    TrackingRawListRow
    """ # noqa: E501
    time_point: StrictStr = Field(alias="timePoint")
    has_webauthn: StrictBool = Field(alias="hasWebauthn")
    has_platform_auth: StrictBool = Field(alias="hasPlatformAuth")
    has_conditional_ui: StrictBool = Field(alias="hasConditionalUi")
    os_id: StrictStr = Field(alias="osId")
    browser_id: StrictStr = Field(alias="browserId")
    __properties: ClassVar[List[str]] = ["timePoint", "hasWebauthn", "hasPlatformAuth", "hasConditionalUi", "osId", "browserId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TrackingRawListRow from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TrackingRawListRow from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "hasWebauthn": obj.get("hasWebauthn"),
            "hasPlatformAuth": obj.get("hasPlatformAuth"),
            "hasConditionalUi": obj.get("hasConditionalUi"),
            "osId": obj.get("osId"),
