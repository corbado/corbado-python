...
class TrackingEnums(BaseModel):
    """
    TrackingEnums
    """ # noqa: E501
    browser_names: List[StrictStr] = Field(alias="browserNames")
    os_names: List[StrictStr] = Field(alias="osNames")
    os_platforms: List[StrictStr] = Field(alias="osPlatforms")
    __properties: ClassVar[List[str]] = ["browserNames", "osNames", "osPlatforms"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TrackingEnums from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TrackingEnums from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "browserNames": obj.get("browserNames"),
            "osNames": obj.get("osNames"),
            "osPlatforms": obj.get("osPlatforms")
        })
        return _obj
