...
class AndroidAppConfigItem(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "projectID", "packageName", "fingerprint", "base64URL", "created", "updated"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AndroidAppConfigItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AndroidAppConfigItem from a dict"""
        if obj is None:
            return None
