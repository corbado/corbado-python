...
class SmsTemplateCreateRspAllOfData(BaseModel):
    """
    SmsTemplateCreateRspAllOfData
    """ # noqa: E501
    sms_template_id: StrictStr = Field(alias="smsTemplateID")
    __properties: ClassVar[List[str]] = ["smsTemplateID"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SmsTemplateCreateRspAllOfData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SmsTemplateCreateRspAllOfData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "smsTemplateID": obj.get("smsTemplateID")
        })
        return _obj
