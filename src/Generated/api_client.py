...
from python_generate.api_response import ApiResponse, T as ApiResponseT
import python_generate.models
from python_generate import rest
from python_generate.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(python_generate.models, klass)
