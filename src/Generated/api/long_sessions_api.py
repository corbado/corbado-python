...
class LongSessionsApi:
    ...
    def _long_session_get_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/longSessions/{sessionID}',
    ...
    def long_session_list(
        ...
        _param = self._long_session_list_serialize(
    ...
    @validate_call
    def long_session_list_with_http_info(
        self,
        remote_address: Annotated[Optional[StrictStr], Field(description="Client's remote address")] = None,
        user_agent: Annotated[Optional[StrictStr], Field(description="Client's user agent")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="Field sorting")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[LongSessionListRsp]:
        """long_session_list
    ...
    @validate_call
    def long_session_list_without_preload_content(
        self,
        remote_address: Annotated[Optional[StrictStr], Field(description="Client's remote address")] = None,
        user_agent: Annotated[Optional[StrictStr], Field(description="Client's user agent")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="Field sorting")] = None,
    ...
    def _long_session_list_serialize(
        self,
        remote_address,
        user_agent,
        sort,
    ...
    @validate_call
    def long_session_revoke(
        self,
        session_id: Annotated[str, Field(min_length=30, strict=True, max_length=30, description="ID of session")],
        long_session_revoke_req: Optional[LongSessionRevokeReq] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param session_id: ID of session (required)
        :type session_id: str
        :param long_session_revoke_req:
        :type long_session_revoke_req: LongSessionRevokeReq
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._long_session_revoke_serialize(
            session_id=session_id,
            long_session_revoke_req=long_session_revoke_req,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def long_session_revoke_with_http_info(
        self,
        session_id: Annotated[str, Field(min_length=30, strict=True, max_length=30, description="ID of session")],
        long_session_revoke_req: Optional[LongSessionRevokeReq] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def long_session_revoke_without_preload_content(
        self,
        session_id: Annotated[str, Field(min_length=30, strict=True, max_length=30, description="ID of session")],
        long_session_revoke_req: Optional[LongSessionRevokeReq] = None,
        _request_timeout: Union[
    ...
    def _long_session_revoke_serialize(
        self,
        session_id,
        long_session_revoke_req,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if long_session_revoke_req is not None:
            _body_params = long_session_revoke_req
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/v1/longSessions/{sessionID}/revoke',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
