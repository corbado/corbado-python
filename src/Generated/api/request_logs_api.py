...
class RequestLogsApi:
    ...
    def request_log_get(
        self,
        request_id: Annotated[StrictStr, Field(description="ID of request")],
        ...
        :param request_id: ID of request (required)
        :type request_id: str
        ...
        _param = self._request_log_get_serialize(
    ...
    @validate_call
    def request_log_get_with_http_info(
        self,
        request_id: Annotated[StrictStr, Field(description="ID of request")],
        remote_address: Annotated[Optional[StrictStr], Field(description="Client's remote address")] = None,
        user_agent: Annotated[Optional[StrictStr], Field(description="Client's user agent")] = None,
    ...
    @validate_call
    def request_log_get_without_preload_content(
        self,
        request_id: Annotated[StrictStr, Field(description="ID of request")],
        remote_address: Annotated[Optional[StrictStr], Field(description="Client's remote address")] = None,
        user_agent: Annotated[Optional[StrictStr], Field(description="Client's user agent")] = None,
    ...
    def _request_log_get_serialize(
        self,
        request_id,
        remote_address,
        user_agent,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/requestLogs/{requestID}',
    ...
    def request_logs_list(
        ...
        _param = self._request_logs_list_serialize(
            remote_address=remote_address,
            user_agent=user_agent,
            sort=sort,
            filter=filter,
    ...
    @validate_call
    def request_logs_list_with_http_info(
        self,
        remote_address: Annotated[Optional[StrictStr], Field(description="Client's remote address")] = None,
        user_agent: Annotated[Optional[StrictStr], Field(description="Client's user agent")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="Field sorting")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RequestLogsListRsp]:
        """request_logs_list
    ...
    @validate_call
    def request_logs_list_without_preload_content(
        self,
        remote_address: Annotated[Optional[StrictStr], Field(description="Client's remote address")] = None,
        user_agent: Annotated[Optional[StrictStr], Field(description="Client's user agent")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="Field sorting")] = None,
    ...
    def _request_logs_list_serialize(
        self,
        remote_address,
        user_agent,
        sort,
