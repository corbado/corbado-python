...
class SMSOTPApi:
    ...
    def sms_code_send(
        self,
        sms_code_send_req: SmsCodeSendReq,
        ...
        :param sms_code_send_req: (required)
        :type sms_code_send_req: SmsCodeSendReq
        ...
        _param = self._sms_code_send_serialize(
            sms_code_send_req=sms_code_send_req,
    ...
    @validate_call
    def sms_code_send_with_http_info(
        self,
        sms_code_send_req: SmsCodeSendReq,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def sms_code_send_without_preload_content(
        self,
        sms_code_send_req: SmsCodeSendReq,
        _request_timeout: Union[
            None,
    ...
    def _sms_code_send_serialize(
        ...
        if sms_code_send_req is not None:
            _body_params = sms_code_send_req
    ...
    def sms_code_validate(
        self,
        sms_code_id: Annotated[StrictStr, Field(description="ID of SMS OTP")],
        sms_code_validate_req: SmsCodeValidateReq,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param sms_code_id: ID of SMS OTP (required)
        :type sms_code_id: str
        :param sms_code_validate_req: (required)
        :type sms_code_validate_req: SmsCodeValidateReq
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._sms_code_validate_serialize(
            sms_code_id=sms_code_id,
            sms_code_validate_req=sms_code_validate_req,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def sms_code_validate_with_http_info(
        self,
        sms_code_id: Annotated[StrictStr, Field(description="ID of SMS OTP")],
        sms_code_validate_req: SmsCodeValidateReq,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SmsCodeValidateRsp]:
        """sms_code_validate
    ...
    @validate_call
    def sms_code_validate_without_preload_content(
        self,
        sms_code_id: Annotated[StrictStr, Field(description="ID of SMS OTP")],
        sms_code_validate_req: SmsCodeValidateReq,
        _request_timeout: Union[
    ...
    def _sms_code_validate_serialize(
        self,
        sms_code_id,
        sms_code_validate_req,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the path parameters
        if sms_code_id is not None:
            _path_params['smsCodeID'] = sms_code_id
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        if sms_code_validate_req is not None:
            _body_params = sms_code_validate_req
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/v1/smsCodes/{smsCodeID}/validate',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
