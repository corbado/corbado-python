...
class AuthTokensApi:
    ...
    @validate_call
    def auth_token_validate(
        self,
        auth_token_validate_req: AuthTokenValidateReq,
        ...
        :param auth_token_validate_req: (required)
        :type auth_token_validate_req: AuthTokenValidateReq
        ...
        _param = self._auth_token_validate_serialize(
            auth_token_validate_req=auth_token_validate_req,
    ...
    @validate_call
    def auth_token_validate_with_http_info(
        self,
        auth_token_validate_req: AuthTokenValidateReq,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AuthTokenValidateRsp]:
        """auth_token_validate
    ...
    @validate_call
    def auth_token_validate_without_preload_content(
        self,
        auth_token_validate_req: AuthTokenValidateReq,
        _request_timeout: Union[
            None,
    ...
    def _auth_token_validate_serialize(
        self,
        auth_token_validate_req,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if auth_token_validate_req is not None:
            _body_params = auth_token_validate_req
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/authTokens/validate',
