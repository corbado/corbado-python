...
class WebhookLogsApi:
    ...
    def webhook_logs_list(
        ...
        _param = self._webhook_logs_list_serialize(
    ...
    @validate_call
    def webhook_logs_list_with_http_info(
        self,
        remote_address: Annotated[Optional[StrictStr], Field(description="Client's remote address")] = None,
        user_agent: Annotated[Optional[StrictStr], Field(description="Client's user agent")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="Field sorting")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[WebhookLogsListRsp]:
        """webhook_logs_list
    ...
    @validate_call
    def webhook_logs_list_without_preload_content(
        self,
        remote_address: Annotated[Optional[StrictStr], Field(description="Client's remote address")] = None,
        user_agent: Annotated[Optional[StrictStr], Field(description="Client's user agent")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="Field sorting")] = None,
    ...
    def _webhook_logs_list_serialize(
        self,
        remote_address,
        user_agent,
        sort,
