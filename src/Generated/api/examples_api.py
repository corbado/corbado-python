...
class ExamplesApi:
    ...
    def example_get(
        self,
        file_name: Annotated[StrictStr, Field(description="Name of the example to get")],
        ...
        :param file_name: Name of the example to get (required)
        :type file_name: str
    ...
    def _example_get_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/examples/{fileName}',
