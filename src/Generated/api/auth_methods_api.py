...
class AuthMethodsApi:
    ...
    @validate_call
    def auth_methods_list(
        self,
        auth_methods_list_req: AuthMethodsListReq,
        ...
        :param auth_methods_list_req: (required)
        :type auth_methods_list_req: AuthMethodsListReq
        ...
        _param = self._auth_methods_list_serialize(
            auth_methods_list_req=auth_methods_list_req,
    ...
    @validate_call
    def auth_methods_list_with_http_info(
        self,
        auth_methods_list_req: AuthMethodsListReq,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AuthMethodsListRsp]:
        """auth_methods_list
    ...
    @validate_call
    def auth_methods_list_without_preload_content(
        self,
        auth_methods_list_req: AuthMethodsListReq,
        _request_timeout: Union[
            None,
    ...
    def _auth_methods_list_serialize(
        self,
        auth_methods_list_req,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if auth_methods_list_req is not None:
            _body_params = auth_methods_list_req
