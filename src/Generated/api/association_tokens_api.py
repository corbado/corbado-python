...
class AssociationTokensApi:
    ...
    @validate_call
    def association_token_create(
        self,
        association_token_create_req: AssociationTokenCreateReq,
        ...
        """association_token_create

        Creates a new association token

        :param association_token_create_req: (required)
        :type association_token_create_req: AssociationTokenCreateReq
        ...
        _param = self._association_token_create_serialize(
            association_token_create_req=association_token_create_req,
    ...
    @validate_call
    def association_token_create_with_http_info(
        self,
        association_token_create_req: AssociationTokenCreateReq,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AssociationTokenCreateRsp]:
        """association_token_create
    ...
    @validate_call
    def association_token_create_without_preload_content(
        self,
        association_token_create_req: AssociationTokenCreateReq,
        _request_timeout: Union[
            None,
    ...
    def _association_token_create_serialize(
        self,
        association_token_create_req,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if association_token_create_req is not None:
            _body_params = association_token_create_req
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/associationTokens',
