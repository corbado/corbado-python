...
class SMSTemplatesApi:
    ...
    def sms_template_create(
        self,
        sms_template_create_req: SmsTemplateCreateReq,
        ...
        :param sms_template_create_req: (required)
        :type sms_template_create_req: SmsTemplateCreateReq
        ...
        _param = self._sms_template_create_serialize(
            sms_template_create_req=sms_template_create_req,
    ...
    @validate_call
    def sms_template_create_with_http_info(
        self,
        sms_template_create_req: SmsTemplateCreateReq,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SmsTemplateCreateRsp]:
        """sms_template_create
    ...
    @validate_call
    def sms_template_create_without_preload_content(
        self,
        sms_template_create_req: SmsTemplateCreateReq,
        _request_timeout: Union[
            None,
    ...
    def _sms_template_create_serialize(
        self,
        sms_template_create_req,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if sms_template_create_req is not None:
            _body_params = sms_template_create_req
    ...
    def sms_template_delete(
        self,
        sms_template_id: Annotated[StrictStr, Field(description="ID of SMS template")],
        sms_template_delete_req: SmsTemplateDeleteReq,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param sms_template_id: ID of SMS template (required)
        :type sms_template_id: str
        :param sms_template_delete_req: (required)
        :type sms_template_delete_req: SmsTemplateDeleteReq
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._sms_template_delete_serialize(
            sms_template_id=sms_template_id,
            sms_template_delete_req=sms_template_delete_req,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def sms_template_delete_with_http_info(
        self,
        sms_template_id: Annotated[StrictStr, Field(description="ID of SMS template")],
        sms_template_delete_req: SmsTemplateDeleteReq,
        _request_timeout: Union[
    ...
    @validate_call
    def sms_template_delete_without_preload_content(
        self,
        sms_template_id: Annotated[StrictStr, Field(description="ID of SMS template")],
        sms_template_delete_req: SmsTemplateDeleteReq,
        _request_timeout: Union[
    ...
    def _sms_template_delete_serialize(
        self,
        sms_template_id,
        sms_template_delete_req,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if sms_template_id is not None:
            _path_params['smsTemplateID'] = sms_template_id
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        if sms_template_delete_req is not None:
            _body_params = sms_template_delete_req
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/v1/smsTemplates/{smsTemplateID}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
