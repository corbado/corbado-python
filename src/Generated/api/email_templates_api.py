...
class EmailTemplatesApi:
    ...
    def email_template_create(
        self,
        email_template_create_req: EmailTemplateCreateReq,
        ...
        :param email_template_create_req: (required)
        :type email_template_create_req: EmailTemplateCreateReq
        ...
        _param = self._email_template_create_serialize(
            email_template_create_req=email_template_create_req,
    ...
    @validate_call
    def email_template_create_with_http_info(
        self,
        email_template_create_req: EmailTemplateCreateReq,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EmailTemplateCreateRsp]:
        """email_template_create
    ...
    @validate_call
    def email_template_create_without_preload_content(
        self,
        email_template_create_req: EmailTemplateCreateReq,
        _request_timeout: Union[
            None,
    ...
    def _email_template_create_serialize(
        self,
        ...
        if email_template_create_req is not None:
            _body_params = email_template_create_req
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/emailTemplates',
    ...
    def email_template_delete(
        self,
        email_template_id: Annotated[StrictStr, Field(description="ID of email template")],
        email_template_delete_req: EmailTemplateDeleteReq,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param email_template_id: ID of email template (required)
        :type email_template_id: str
        :param email_template_delete_req: (required)
        :type email_template_delete_req: EmailTemplateDeleteReq
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _email_template_delete_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if email_template_delete_req is not None:
            _body_params = email_template_delete_req
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/v1/emailTemplates/{emailTemplateID}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
