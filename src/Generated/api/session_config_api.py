...
class SessionConfigApi:
    ...
    def session_config_get(
        self,
        app_type: Annotated[Optional[AppType], Field(description="Application type")] = None,
        ...
        _param = self._session_config_get_serialize(
            app_type=app_type,
    ...
    @validate_call
    def session_config_get_with_http_info(
        self,
        app_type: Annotated[Optional[AppType], Field(description="Application type")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SessionConfigGetRsp]:
        """session_config_get
    ...
    @validate_call
    def session_config_get_without_preload_content(
        self,
        app_type: Annotated[Optional[AppType], Field(description="Application type")] = None,
        _request_timeout: Union[
            None,
    ...
    def _session_config_get_serialize(
        self,
        app_type,
        _request_auth,
        _content_type,
        ...
        if app_type is not None:
            ...
            _query_params.append(('appType', app_type.value))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/sessionConfig',
    ...
    def session_config_update(
        self,
        session_config_update_req: SessionConfigUpdateReq,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param session_config_update_req: (required)
        :type session_config_update_req: SessionConfigUpdateReq
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._session_config_update_serialize(
            session_config_update_req=session_config_update_req,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def session_config_update_with_http_info(
        self,
        session_config_update_req: SessionConfigUpdateReq,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def session_config_update_without_preload_content(
        self,
        session_config_update_req: SessionConfigUpdateReq,
        _request_timeout: Union[
            None,
    ...
    def _session_config_update_serialize(
        self,
        session_config_update_req,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if session_config_update_req is not None:
            _body_params = session_config_update_req
