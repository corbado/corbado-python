...
class ValidationApi:
    ...
    def validate_email(
        self,
        validate_email_req: ValidateEmailReq,
        ...
        :param validate_email_req: (required)
        :type validate_email_req: ValidateEmailReq
    ...
    def _validate_email_serialize(
        ...
        if validate_email_req is not None:
            _body_params = validate_email_req
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/v1/validate/email',
    ...
    def validate_phone_number(
        self,
        validate_phone_number_req: ValidatePhoneNumberReq,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param validate_phone_number_req: (required)
        :type validate_phone_number_req: ValidatePhoneNumberReq
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._validate_phone_number_serialize(
            validate_phone_number_req=validate_phone_number_req,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def validate_phone_number_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ValidatePhoneNumberRsp]:
        """validate_phone_number
    ...
    def _validate_phone_number_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if validate_phone_number_req is not None:
            _body_params = validate_phone_number_req
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/v1/validate/phoneNumber',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
