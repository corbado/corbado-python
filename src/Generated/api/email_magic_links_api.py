...
class EmailMagicLinksApi:
    ...
    def email_link_delete(
        self,
        email_link_id: Annotated[StrictStr, Field(description="ID of email magic link")],
        email_links_delete_req: Optional[EmailLinksDeleteReq] = None,
        ...
        :param email_link_id: ID of email magic link (required)
        :type email_link_id: str
        :param email_links_delete_req:
        :type email_links_delete_req: EmailLinksDeleteReq
        ...
        _param = self._email_link_delete_serialize(
            ...
            email_links_delete_req=email_links_delete_req,
    ...
    def email_link_delete_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EmailLinkValidateRsp]:
        """email_link_delete
    ...
    def email_link_send(
        self,
        email_link_send_req: EmailLinkSendReq,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param email_link_send_req: (required)
        :type email_link_send_req: EmailLinkSendReq
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def email_link_validate(
        self,
        email_link_id: Annotated[StrictStr, Field(description="ID of email magic link")],
        email_links_validate_req: EmailLinksValidateReq,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param email_link_id: ID of email magic link (required)
        :type email_link_id: str
        :param email_links_validate_req: (required)
        :type email_links_validate_req: EmailLinksValidateReq
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._email_link_validate_serialize(
            email_link_id=email_link_id,
            email_links_validate_req=email_links_validate_req,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
