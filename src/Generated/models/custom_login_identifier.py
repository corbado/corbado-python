...
class CustomLoginIdentifier(BaseModel):
    """
    CustomLoginIdentifier
    """ # noqa: E501
    id: StrictStr = Field(description="ID of the phone number", alias="ID")
    ...
    __properties: ClassVar[List[str]] = ["ID", "identifier", "additionalData", "created", "updated"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CustomLoginIdentifier from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CustomLoginIdentifier from a dict"""
        if obj is None:
            return None
