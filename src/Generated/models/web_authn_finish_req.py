...
class WebAuthnFinishReq(BaseModel):
    """
    WebAuthnFinishReq
    """ # noqa: E501
    public_key_credential: StrictStr = Field(description="Contains JSON payload data for Passkeys (Biometrics) login finish challenge", alias="publicKeyCredential")
    ...
    __properties: ClassVar[List[str]] = ["publicKeyCredential", "requestID", "clientInfo"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebAuthnFinishReq from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebAuthnFinishReq from a dict"""
        if obj is None:
            return None
