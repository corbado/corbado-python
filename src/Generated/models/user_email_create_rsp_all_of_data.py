...
class UserEmailCreateRspAllOfData(BaseModel):
    """
    UserEmailCreateRspAllOfData
    """ # noqa: E501
    email_id: StrictStr = Field(alias="emailID")
    __properties: ClassVar[List[str]] = ["emailID"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserEmailCreateRspAllOfData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserEmailCreateRspAllOfData from a dict"""
        if obj is None:
            return None
