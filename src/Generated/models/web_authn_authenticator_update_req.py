...
class WebAuthnAuthenticatorUpdateReq(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "requestID", "clientInfo"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebAuthnAuthenticatorUpdateReq from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebAuthnAuthenticatorUpdateReq from a dict"""
        if obj is None:
            return None
