...
class WebAuthnCredentialExistsReq(BaseModel):
    """
    WebAuthnCredentialExistsReq
    """ # noqa: E501
    login_identifier: StrictStr = Field(alias="loginIdentifier")
    login_identifier_type: LoginIdentifierType = Field(alias="loginIdentifierType")
    ...
    __properties: ClassVar[List[str]] = ["loginIdentifier", "loginIdentifierType", "requestID", "clientInfo"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebAuthnCredentialExistsReq from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebAuthnCredentialExistsReq from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "loginIdentifier": obj.get("loginIdentifier"),
            "loginIdentifierType": obj.get("loginIdentifierType"),
