...
class UserStats(BaseModel):
    ...
    UserStats
    """ # noqa: E501
    time_point: StrictStr = Field(alias="timePoint")
    total_users: StrictInt = Field(alias="totalUsers")
    sign_ups: StrictInt = Field(alias="signUps")
    active_users: StrictInt = Field(alias="activeUsers")
    count_passkey_login: StrictInt = Field(alias="countPasskeyLogin")
    count_email_login: StrictInt = Field(alias="countEmailLogin")
    count_password_login: StrictInt = Field(alias="countPasswordLogin")
    successful_logins: StrictInt = Field(alias="successfulLogins")
    failed_logins: StrictInt = Field(alias="failedLogins")
    __properties: ClassVar[List[str]] = ["timePoint", "totalUsers", "signUps", "activeUsers", "countPasskeyLogin", "countEmailLogin", "countPasswordLogin", "successfulLogins", "failedLogins"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "countPasskeyLogin": obj.get("countPasskeyLogin"),
            "countEmailLogin": obj.get("countEmailLogin"),
            "countPasswordLogin": obj.get("countPasswordLogin"),
            "successfulLogins": obj.get("successfulLogins"),
            "failedLogins": obj.get("failedLogins")
        })
        return _obj
