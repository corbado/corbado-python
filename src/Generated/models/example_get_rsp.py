...
class ExampleGetRsp(BaseModel):
    ...
    data: StrictStr = Field(description="Base64 encoded data containing the compressed example file")
    extension: StrictStr = Field(description="The extension of the compressed example file")
    __properties: ClassVar[List[str]] = ["httpStatusCode", "message", "requestData", "runtime", "data", "extension"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExampleGetRsp from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExampleGetRsp from a dict"""
        if obj is None:
            return None
