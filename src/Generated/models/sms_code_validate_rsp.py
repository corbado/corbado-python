...
class SmsCodeValidateRsp(BaseModel):
    """
    SmsCodeValidateRsp
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["httpStatusCode", "message", "requestData", "runtime", "loginToken"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SmsCodeValidateRsp from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SmsCodeValidateRsp from a dict"""
        if obj is None:
            return None
