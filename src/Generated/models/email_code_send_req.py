...
class EmailCodeSendReq(BaseModel):
    """
    EmailCodeSendReq
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["email", "create", "tokenLifetime", "userFullName", "templateName", "additionalPayload", "requestID", "clientInfo"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EmailCodeSendReq from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EmailCodeSendReq from a dict"""
        if obj is None:
            return None
