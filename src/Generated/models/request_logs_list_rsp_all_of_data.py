...
class RequestLogsListRspAllOfData(BaseModel):
    """
    RequestLogsListRspAllOfData
    """ # noqa: E501
    logs: List[RequestLog]
    paging: Paging
    __properties: ClassVar[List[str]] = ["logs", "paging"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RequestLogsListRspAllOfData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RequestLogsListRspAllOfData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "logs": [RequestLog.from_dict(_item) for _item in obj["logs"]] if obj.get("logs") is not None else None,
