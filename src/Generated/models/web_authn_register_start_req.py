...
class WebAuthnRegisterStartReq(BaseModel):
    """
    ...
    credential_status: Optional[StrictStr] = Field(default='pending', description="Sets credential status into active and pending. Pending status dont allow a login until the credential gets confirmed by an api call.", alias="credentialStatus")
    __properties: ClassVar[List[str]] = ["username", "userFullName", "requestID", "clientInfo", "credentialStatus"]

    @field_validator('credential_status')
    def credential_status_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebAuthnRegisterStartReq from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebAuthnRegisterStartReq from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "credentialStatus": obj.get("credentialStatus") if obj.get("credentialStatus") is not None else 'pending'
        })
        return _obj
