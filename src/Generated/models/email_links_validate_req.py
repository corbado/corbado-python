...
class EmailLinksValidateReq(BaseModel):
    """
    EmailLinksValidateReq
    """ # noqa: E501
    token: StrictStr = Field(description="Token to validate")
    ...
    __properties: ClassVar[List[str]] = ["token", "createLoginToken", "requestID", "clientInfo"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EmailLinksValidateReq from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EmailLinksValidateReq from a dict"""
        if obj is None:
            return None
