...
class UserCustomLoginIdentifierCreateReq(BaseModel):
    """
    UserCustomLoginIdentifierCreateReq
    """ # noqa: E501
    custom_login_identifier: StrictStr = Field(alias="customLoginIdentifier")
    ...
    __properties: ClassVar[List[str]] = ["customLoginIdentifier", "additionalData", "requestID", "clientInfo"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserCustomLoginIdentifierCreateReq from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserCustomLoginIdentifierCreateReq from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "customLoginIdentifier": obj.get("customLoginIdentifier"),
