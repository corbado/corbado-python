...
class WebAuthnAuthenticateSuccess(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["httpStatusCode", "message", "requestData", "runtime", "userID", "username", "credentialID", "userFullName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebAuthnAuthenticateSuccess from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebAuthnAuthenticateSuccess from a dict"""
        if obj is None:
            return None
