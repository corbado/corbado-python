...
class WebAuthnMediationStartRsp(BaseModel):
    """
    ...
    challenge: StrictStr = Field(description="Contains JSON payload data to start Passkeys (Biometrics) login challenge")
    __properties: ClassVar[List[str]] = ["httpStatusCode", "message", "requestData", "runtime", "challenge"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebAuthnMediationStartRsp from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebAuthnMediationStartRsp from a dict"""
        if obj is None:
            return None
