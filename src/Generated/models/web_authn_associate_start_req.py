...
class WebAuthnAssociateStartReq(BaseModel):
    """
    WebAuthnAssociateStartReq
    """ # noqa: E501
    association_token: StrictStr = Field(alias="associationToken")
    ...
    __properties: ClassVar[List[str]] = ["associationToken", "requestID", "clientInfo"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebAuthnAssociateStartReq from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebAuthnAssociateStartReq from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "associationToken": obj.get("associationToken"),
