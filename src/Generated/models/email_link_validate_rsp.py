...
class EmailLinkValidateRsp(BaseModel):
    """
    ...
    login_token: Optional[StrictStr] = Field(default=None, alias="loginToken")
    __properties: ClassVar[List[str]] = ["httpStatusCode", "message", "requestData", "runtime", "additionalPayload", "userID", "userFullName", "userEmail", "loginToken"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EmailLinkValidateRsp from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EmailLinkValidateRsp from a dict"""
        if obj is None:
            return None
