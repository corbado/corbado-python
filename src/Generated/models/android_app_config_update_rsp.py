...
class AndroidAppConfigUpdateRsp(BaseModel):
    """
    ...
    id: StrictStr = Field(description="ID of Android app configuration")
    ...
    base64_url: StrictStr = Field(alias="base64URL")
    ...
    __properties: ClassVar[List[str]] = ["httpStatusCode", "message", "requestData", "runtime", "id", "projectID", "packageName", "fingerprint", "base64URL", "created", "updated"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AndroidAppConfigUpdateRsp from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AndroidAppConfigUpdateRsp from a dict"""
        if obj is None:
            return None
