...
class SmsTemplateCreateReq(BaseModel):
    """
    SmsTemplateCreateReq
    """ # noqa: E501
    type: StrictStr
    name: StrictStr
    text_plain: StrictStr = Field(alias="textPlain")
    ...
    __properties: ClassVar[List[str]] = ["type", "name", "textPlain", "isDefault", "requestID", "clientInfo"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['sms_code', 'passkey_notification']):
            raise ValueError("must be one of enum values ('sms_code', 'passkey_notification')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SmsTemplateCreateReq from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SmsTemplateCreateReq from a dict"""
        if obj is None:
            return None
