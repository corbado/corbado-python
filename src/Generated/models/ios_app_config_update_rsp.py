...
class IOSAppConfigUpdateRsp(BaseModel):
    """
    ...
    id: StrictStr = Field(description="ID of iOS app")
    project_id: StrictStr = Field(description="ID of project", alias="projectID")
    app_id_prefix: StrictStr = Field(alias="appIDPrefix")
    ...
    __properties: ClassVar[List[str]] = ["httpStatusCode", "message", "requestData", "runtime", "id", "projectID", "appIDPrefix", "bundleID", "created", "updated"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IOSAppConfigUpdateRsp from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IOSAppConfigUpdateRsp from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "appIDPrefix": obj.get("appIDPrefix"),
