...
class AndroidAppConfigUpdateReq(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["packageName", "fingerprint", "requestID", "clientInfo"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AndroidAppConfigUpdateReq from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AndroidAppConfigUpdateReq from a dict"""
        if obj is None:
            return None
