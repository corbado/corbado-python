...
class ValidateEmailReq(BaseModel):
    """
    ValidateEmailReq
    """ # noqa: E501
    email: StrictStr = Field(description="Email to validate")
    smtp_check: Optional[StrictBool] = Field(default=None, description="perform SMTP check for domain", alias="smtpCheck")
    suggest_domain: Optional[StrictBool] = Field(default=None, description="enables domain suggestion for misspelled domains", alias="suggestDomain")
    ...
    __properties: ClassVar[List[str]] = ["email", "smtpCheck", "suggestDomain", "requestID", "clientInfo"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ValidateEmailReq from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ValidateEmailReq from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "email": obj.get("email"),
            "smtpCheck": obj.get("smtpCheck"),
            "suggestDomain": obj.get("suggestDomain"),
