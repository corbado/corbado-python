...
class LongSessionListRspAllOfData(BaseModel):
    """
    LongSessionListRspAllOfData
    """ # noqa: E501
    long_sessions: List[LongSession] = Field(alias="longSessions")
    paging: Paging
    __properties: ClassVar[List[str]] = ["longSessions", "paging"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LongSessionListRspAllOfData from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in long_sessions (list)
        _items = []
        if self.long_sessions:
            for _item in self.long_sessions:
                if _item:
                    _items.append(_item.to_dict())
            _dict['longSessions'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LongSessionListRspAllOfData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "longSessions": [LongSession.from_dict(_item) for _item in obj["longSessions"]] if obj.get("longSessions") is not None else None,
