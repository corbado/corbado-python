...
class TrackingBrowserDetailedStatsListRspAllOfData(BaseModel):
    """
    TrackingBrowserDetailedStatsListRspAllOfData
    """ # noqa: E501
    stats: List[TrackingBrowserDetailedStats]
    paging: Paging
    __properties: ClassVar[List[str]] = ["stats", "paging"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TrackingBrowserDetailedStatsListRspAllOfData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TrackingBrowserDetailedStatsListRspAllOfData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "stats": [TrackingBrowserDetailedStats.from_dict(_item) for _item in obj["stats"]] if obj.get("stats") is not None else None,
