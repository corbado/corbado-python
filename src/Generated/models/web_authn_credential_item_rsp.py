...
class WebAuthnCredentialItemRsp(BaseModel):
    """
    ...
    id: StrictStr = Field(description="Credential ID")
    credential_hash: StrictStr = Field(alias="credentialHash")
    aaguid: StrictStr
    attestation_type: StrictStr = Field(alias="attestationType")
    backup_state: Optional[StrictBool] = Field(default=None, description="Backup state", alias="backupState")
    backup_eligible: StrictBool = Field(description="Backup eligible", alias="backupEligible")
    transport: List[StrictStr] = Field(description="Transport")
    ...
    authenticator_id: StrictStr = Field(description="Authenticator ID", alias="authenticatorID")
    authenticator_name: StrictStr = Field(alias="authenticatorName")
    ...
    last_used_device_name: StrictStr = Field(alias="lastUsedDeviceName")
    __properties: ClassVar[List[str]] = ["httpStatusCode", "message", "requestData", "runtime", "id", "credentialHash", "aaguid", "attestationType", "backupState", "backupEligible", "transport", "status", "userAgent", "created", "authenticatorID", "authenticatorName", "lastUsed", "lastUsedDeviceName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebAuthnCredentialItemRsp from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebAuthnCredentialItemRsp from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "credentialHash": obj.get("credentialHash"),
            ...
            "authenticatorName": obj.get("authenticatorName"),
            "lastUsed": obj.get("lastUsed"),
            "lastUsedDeviceName": obj.get("lastUsedDeviceName")
        })
        return _obj
