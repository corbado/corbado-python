...
class WebAuthnCredentialListRsp(BaseModel):
    """
    ...
    rows: List[WebAuthnCredentialItemRsp]
    paging: Paging
    __properties: ClassVar[List[str]] = ["httpStatusCode", "message", "requestData", "runtime", "rows", "paging"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebAuthnCredentialListRsp from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebAuthnCredentialListRsp from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "rows": [WebAuthnCredentialItemRsp.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None,
