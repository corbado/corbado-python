...
class EmailTemplateCreateReq(BaseModel):
    """
    ...
    plain_text_body: StrictStr = Field(alias="plainTextBody")
    html_text_title: StrictStr = Field(alias="htmlTextTitle")
    html_text_body: StrictStr = Field(alias="htmlTextBody")
    html_text_button: StrictStr = Field(alias="htmlTextButton")
    html_color_font: StrictStr = Field(alias="htmlColorFont")
    html_color_background_outer: StrictStr = Field(alias="htmlColorBackgroundOuter")
    html_color_background_inner: StrictStr = Field(alias="htmlColorBackgroundInner")
    html_color_button: StrictStr = Field(alias="htmlColorButton")
    html_color_button_font: StrictStr = Field(alias="htmlColorButtonFont")
    ...
    __properties: ClassVar[List[str]] = ["lang", "type", "name", "subject", "action", "plainTextBody", "htmlTextTitle", "htmlTextBody", "htmlTextButton", "htmlColorFont", "htmlColorBackgroundOuter", "htmlColorBackgroundInner", "htmlColorButton", "htmlColorButtonFont", "isDefault", "requestID", "clientInfo"]

    @field_validator('lang')
    def lang_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['en', 'de', 'fr']):
            raise ValueError("must be one of enum values ('en', 'de', 'fr')")
        return value

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['email_link', 'email_link_login', 'login_notification', 'passkey_notification', 'email_code']):
            raise ValueError("must be one of enum values ('email_link', 'email_link_login', 'login_notification', 'passkey_notification', 'email_code')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EmailTemplateCreateReq from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EmailTemplateCreateReq from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "htmlTextTitle": obj.get("htmlTextTitle"),
            "htmlTextBody": obj.get("htmlTextBody"),
            "htmlTextButton": obj.get("htmlTextButton"),
            "htmlColorFont": obj.get("htmlColorFont"),
            "htmlColorBackgroundOuter": obj.get("htmlColorBackgroundOuter"),
            "htmlColorBackgroundInner": obj.get("htmlColorBackgroundInner"),
            "htmlColorButton": obj.get("htmlColorButton"),
            "htmlColorButtonFont": obj.get("htmlColorButtonFont"),
