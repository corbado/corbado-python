...
class SmsCodeSendReq(BaseModel):
    """
    SmsCodeSendReq
    """ # noqa: E501
    phone_number: StrictStr = Field(description="Recipient phone number", alias="phoneNumber")
    create: StrictBool = Field(description="Defines if user phone number should be created if not found")
    ...
    template_name: Optional[StrictStr] = Field(default=None, description="Template name of SMS to send", alias="templateName")
    ...
    __properties: ClassVar[List[str]] = ["phoneNumber", "create", "userFullName", "templateName", "requestID", "clientInfo"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SmsCodeSendReq from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SmsCodeSendReq from a dict"""
        if obj is None:
            return None
