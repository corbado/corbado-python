...
class SessionTokenVerifyRspAllOfData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["userID", "user", "userData"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SessionTokenVerifyRspAllOfData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SessionTokenVerifyRspAllOfData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "user": FullUser.from_dict(obj["user"]) if obj.get("user") is not None else None,
