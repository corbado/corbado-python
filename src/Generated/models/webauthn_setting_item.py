...
class WebauthnSettingItem(BaseModel):
    """
    WebauthnSettingItem
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["name", "origin", "id", "created", "updated"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebauthnSettingItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebauthnSettingItem from a dict"""
        if obj is None:
            return None
