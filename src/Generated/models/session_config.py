...
class SessionConfig(BaseModel):
    ...
    short_lifetime_minutes: StrictInt = Field(alias="shortLifetimeMinutes")
    short_cookie_domain: StrictStr = Field(alias="shortCookieDomain")
    short_cookie_secure: StrictBool = Field(alias="shortCookieSecure")
    short_cookie_same_site: StrictStr = Field(alias="shortCookieSameSite")
    long_lifetime_value: StrictInt = Field(alias="longLifetimeValue")
    long_lifetime_unit: StrictStr = Field(alias="longLifetimeUnit")
    long_inactivity_value: StrictInt = Field(alias="longInactivityValue")
    long_inactivity_unit: StrictStr = Field(alias="longInactivityUnit")
    jwt_audience: StrictStr = Field(alias="jwtAudience")
    ...
    __properties: ClassVar[List[str]] = ["projectID", "appType", "active", "shortLifetimeMinutes", "shortCookieDomain", "shortCookieSecure", "shortCookieSameSite", "longLifetimeValue", "longLifetimeUnit", "longInactivityValue", "longInactivityUnit", "jwtAudience", "created", "updated"]
    ...
    def long_lifetime_unit_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['min', 'hour', 'day']):
            raise ValueError("must be one of enum values ('min', 'hour', 'day')")
        return value
