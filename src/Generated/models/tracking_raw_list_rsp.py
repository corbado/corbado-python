...
class TrackingRawListRsp(BaseModel):
    """
    TrackingRawListRsp
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TrackingRawListRsp from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TrackingRawListRsp from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "rows": [TrackingRawListRow.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None,
