...
class LongSessionGetRspAllOfData(BaseModel):
    """
    LongSessionGetRspAllOfData
    """ # noqa: E501
    long_session: LongSession = Field(alias="longSession")
    __properties: ClassVar[List[str]] = ["longSession"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LongSessionGetRspAllOfData from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of long_session
        if self.long_session:
            _dict['longSession'] = self.long_session.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LongSessionGetRspAllOfData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "longSession": LongSession.from_dict(obj["longSession"]) if obj.get("longSession") is not None else None
        })
        return _obj
