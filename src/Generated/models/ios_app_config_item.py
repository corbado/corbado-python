...
class IOSAppConfigItem(BaseModel):
    """
    IOSAppConfigItem
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "projectID", "appIDPrefix", "bundleID", "created", "updated"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IOSAppConfigItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IOSAppConfigItem from a dict"""
        if obj is None:
            return None
