...
class WebauthnSettingUpdateRsp(BaseModel):
    """
    ...
    name: StrictStr = Field(description="Name of this setting")
    origin: StrictStr = Field(description="Define here either a url incl. schema or an android-apk-key-hash")
    id: StrictStr = Field(description="ID of WebAuthn setting")
    ...
    __properties: ClassVar[List[str]] = ["httpStatusCode", "message", "requestData", "runtime", "name", "origin", "id", "created", "updated"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebauthnSettingUpdateRsp from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebauthnSettingUpdateRsp from a dict"""
        if obj is None:
            return None
