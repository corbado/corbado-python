...
class SmsCodeValidateReq(BaseModel):
    """
    SmsCodeValidateReq
    """ # noqa: E501
    sms_code: StrictStr = Field(description="SMS OTP to validate", alias="smsCode")
    create_login_token: Optional[StrictBool] = Field(default=None, alias="createLoginToken")
    ...
    __properties: ClassVar[List[str]] = ["smsCode", "createLoginToken", "requestID", "clientInfo"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SmsCodeValidateReq from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SmsCodeValidateReq from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "smsCode": obj.get("smsCode"),
            "createLoginToken": obj.get("createLoginToken"),
