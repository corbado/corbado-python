...
class TrackingBrowserStats(BaseModel):
    """
    ...
    firefox: StrictInt
    other: StrictInt
    __properties: ClassVar[List[str]] = ["timePoint", "chrome", "safari", "edge", "firefox", "other"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TrackingBrowserStats from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TrackingBrowserStats from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "chrome": obj.get("chrome"),
            "safari": obj.get("safari"),
            "edge": obj.get("edge"),
            "firefox": obj.get("firefox"),
            "other": obj.get("other")
        })
        return _obj
