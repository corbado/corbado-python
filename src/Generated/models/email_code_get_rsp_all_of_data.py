...
class EmailCodeGetRspAllOfData(BaseModel):
    """
    EmailCodeGetRspAllOfData
    """ # noqa: E501
    email_code: EmailCode = Field(alias="emailCode")
    __properties: ClassVar[List[str]] = ["emailCode"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EmailCodeGetRspAllOfData from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of email_code
        if self.email_code:
            _dict['emailCode'] = self.email_code.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EmailCodeGetRspAllOfData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "emailCode": EmailCode.from_dict(obj["emailCode"]) if obj.get("emailCode") is not None else None
        })
        return _obj
