...
class AuthMethodsListRspAllOfData(BaseModel):
    """
    AuthMethodsListRspAllOfData
    """ # noqa: E501
    select_methods: List[AuthMethod] = Field(alias="selectMethods")
    possible_methods: List[AuthMethod] = Field(alias="possibleMethods")
    paging: Paging
    __properties: ClassVar[List[str]] = ["selectMethods", "possibleMethods", "paging"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AuthMethodsListRspAllOfData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AuthMethodsListRspAllOfData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "selectMethods": obj.get("selectMethods"),
            "possibleMethods": obj.get("possibleMethods"),
