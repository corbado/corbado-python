...
class ValidationPhoneNumber(BaseModel):
    """
    ValidationPhoneNumber
    """ # noqa: E501
    national_number: StrictInt = Field(alias="nationalNumber")
    country_code: StrictInt = Field(alias="countryCode")
    region_code: StrictStr = Field(alias="regionCode")
    national_formatted: StrictStr = Field(alias="nationalFormatted")
    international_formatted: StrictStr = Field(alias="internationalFormatted")
    __properties: ClassVar[List[str]] = ["nationalNumber", "countryCode", "regionCode", "nationalFormatted", "internationalFormatted"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ValidationPhoneNumber from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ValidationPhoneNumber from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "nationalFormatted": obj.get("nationalFormatted"),
            "internationalFormatted": obj.get("internationalFormatted")
        })
        return _obj
