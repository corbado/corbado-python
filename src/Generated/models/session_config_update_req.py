...
class SessionConfigUpdateReq(BaseModel):
    """
    SessionConfigUpdateReq
    """ # noqa: E501
    app_type: AppType = Field(alias="appType")
    active: Optional[StrictBool] = None
    short_lifetime_minutes: Optional[StrictInt] = Field(default=None, alias="shortLifetimeMinutes")
    short_cookie_domain: Optional[StrictStr] = Field(default=None, alias="shortCookieDomain")
    short_cookie_secure: Optional[StrictBool] = Field(default=None, alias="shortCookieSecure")
    short_cookie_same_site: Optional[StrictStr] = Field(default=None, alias="shortCookieSameSite")
    long_lifetime_value: Optional[StrictInt] = Field(default=None, alias="longLifetimeValue")
    long_lifetime_unit: Optional[StrictStr] = Field(default=None, alias="longLifetimeUnit")
    long_inactivity_value: Optional[StrictInt] = Field(default=None, alias="longInactivityValue")
    long_inactivity_unit: Optional[StrictStr] = Field(default=None, alias="longInactivityUnit")
    jwt_audience: Optional[StrictStr] = Field(default=None, alias="jwtAudience")
    ...
    __properties: ClassVar[List[str]] = ["appType", "active", "shortLifetimeMinutes", "shortCookieDomain", "shortCookieSecure", "shortCookieSameSite", "longLifetimeValue", "longLifetimeUnit", "longInactivityValue", "longInactivityUnit", "jwtAudience", "requestID", "clientInfo"]

    @field_validator('short_cookie_same_site')
    def short_cookie_same_site_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        if value not in set(['lax', 'strict', 'none']):
            raise ValueError("must be one of enum values ('lax', 'strict', 'none')")
        return value

    @field_validator('long_lifetime_unit')
    def long_lifetime_unit_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        if value not in set(['min', 'hour']):
            raise ValueError("must be one of enum values ('min', 'hour')")
        return value

    @field_validator('long_inactivity_unit')
    def long_inactivity_unit_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SessionConfigUpdateReq from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SessionConfigUpdateReq from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "shortLifetimeMinutes": obj.get("shortLifetimeMinutes"),
            "shortCookieDomain": obj.get("shortCookieDomain"),
            "shortCookieSecure": obj.get("shortCookieSecure"),
            "shortCookieSameSite": obj.get("shortCookieSameSite"),
            "longLifetimeValue": obj.get("longLifetimeValue"),
            "longLifetimeUnit": obj.get("longLifetimeUnit"),
            "longInactivityValue": obj.get("longInactivityValue"),
            "longInactivityUnit": obj.get("longInactivityUnit"),
