...
class SessionTokenCreateReq(BaseModel):
    """
    SessionTokenCreateReq
    """ # noqa: E501
    user_id: StrictStr = Field(description="ID of the user", alias="userID")
    user_data: StrictStr = Field(description="Additional user data in JSON format", alias="userData")
    ...
    __properties: ClassVar[List[str]] = ["userID", "userData", "requestID", "clientInfo"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SessionTokenCreateReq from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SessionTokenCreateReq from a dict"""
        if obj is None:
            return None
