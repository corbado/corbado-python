...
class WebAuthnCredentialExistsRsp(BaseModel):
    """
    ...
    exists: StrictBool
    __properties: ClassVar[List[str]] = ["httpStatusCode", "message", "requestData", "runtime", "exists"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebAuthnCredentialExistsRsp from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebAuthnCredentialExistsRsp from a dict"""
        if obj is None:
            return None
