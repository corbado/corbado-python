...
class UserCustomLoginIdentifierGetRspAllOfData(BaseModel):
    """
    UserCustomLoginIdentifierGetRspAllOfData
    """ # noqa: E501
    custom_login_identifier: CustomLoginIdentifier = Field(alias="customLoginIdentifier")
    __properties: ClassVar[List[str]] = ["customLoginIdentifier"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserCustomLoginIdentifierGetRspAllOfData from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of custom_login_identifier
        if self.custom_login_identifier:
            _dict['customLoginIdentifier'] = self.custom_login_identifier.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserCustomLoginIdentifierGetRspAllOfData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "customLoginIdentifier": CustomLoginIdentifier.from_dict(obj["customLoginIdentifier"]) if obj.get("customLoginIdentifier") is not None else None
        })
        return _obj
