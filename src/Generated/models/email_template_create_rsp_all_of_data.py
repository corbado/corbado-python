...
class EmailTemplateCreateRspAllOfData(BaseModel):
    """
    EmailTemplateCreateRspAllOfData
    """ # noqa: E501
    email_template_id: StrictStr = Field(alias="emailTemplateID")
    __properties: ClassVar[List[str]] = ["emailTemplateID"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EmailTemplateCreateRspAllOfData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EmailTemplateCreateRspAllOfData from a dict"""
        if obj is None:
            return None
