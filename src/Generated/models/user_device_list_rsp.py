...
class UserDeviceListRsp(BaseModel):
    """
    UserDeviceListRsp
    """ # noqa: E501
    ...
    paging: Paging
    __properties: ClassVar[List[str]] = ["httpStatusCode", "message", "requestData", "runtime", "devices", "paging"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserDeviceListRsp from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserDeviceListRsp from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "devices": [UserDevice.from_dict(_item) for _item in obj["devices"]] if obj.get("devices") is not None else None,
