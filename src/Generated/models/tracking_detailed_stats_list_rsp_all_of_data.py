...
class TrackingDetailedStatsListRspAllOfData(BaseModel):
    """
    TrackingDetailedStatsListRspAllOfData
    """ # noqa: E501
    stats: List[TrackingDetailedStats]
    paging: Paging
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TrackingDetailedStatsListRspAllOfData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TrackingDetailedStatsListRspAllOfData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "stats": [TrackingDetailedStats.from_dict(_item) for _item in obj["stats"]] if obj.get("stats") is not None else None,
