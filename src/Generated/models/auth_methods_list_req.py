...
class AuthMethodsListReq(BaseModel):
    """
    AuthMethodsListReq
    """ # noqa: E501
    username: StrictStr = Field(description="Client's username")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AuthMethodsListReq from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AuthMethodsListReq from a dict"""
        if obj is None:
            return None
