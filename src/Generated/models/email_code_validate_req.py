...
class EmailCodeValidateReq(BaseModel):
    """
    EmailCodeValidateReq
    """ # noqa: E501
    code: StrictStr = Field(description="Email OTP to validate")
    ...
    __properties: ClassVar[List[str]] = ["code", "createLoginToken", "requestID", "clientInfo"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EmailCodeValidateReq from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EmailCodeValidateReq from a dict"""
        if obj is None:
            return None
