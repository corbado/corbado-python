...
class ProjectConfigWebhookTestReq(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["action", "requestID", "clientInfo"]

    @field_validator('action')
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['authMethods', 'passwordVerify']):
            raise ValueError("must be one of enum values ('authMethods', 'passwordVerify')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProjectConfigWebhookTestReq from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProjectConfigWebhookTestReq from a dict"""
        if obj is None:
            return None
