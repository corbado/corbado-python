...
class WebAuthnMediationStartReq(BaseModel):
    """
    WebAuthnMediationStartReq
    """ # noqa: E501
    username: Optional[StrictStr] = Field(default=None, description="Optional limits possible credentials matching to username")
    ...
    __properties: ClassVar[List[str]] = ["username", "requestID", "clientInfo"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebAuthnMediationStartReq from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebAuthnMediationStartReq from a dict"""
        if obj is None:
            return None
