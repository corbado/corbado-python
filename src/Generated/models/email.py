...
class Email(BaseModel):
    ...
    Email
    """ # noqa: E501
    id: StrictStr = Field(description="ID of the email", alias="ID")
    email: StrictStr
    ...
    deleted: Optional[StrictStr] = Field(default=None, description="Timestamp of when the entity was deleted in yyyy-MM-dd'T'HH:mm:ss format")
    status: Status
    __properties: ClassVar[List[str]] = ["ID", "email", "created", "updated", "deleted", "status"]
