...
class ProjectSecretCreateRsp(BaseModel):
    """
    ...
    id: StrictStr = Field(description="ID of project secret")
    secret: Optional[StrictStr] = Field(default=None, description="Server-side generated secret. Only filled on create")
    hint: StrictStr = Field(description="Hint of the server-side generated secret. First 3 characters and last 3 characters")
    created: StrictStr = Field(description="Timestamp of when the entity was created in yyyy-MM-dd'T'HH:mm:ss format")
    __properties: ClassVar[List[str]] = ["httpStatusCode", "message", "requestData", "runtime", "id", "secret", "hint", "created"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProjectSecretCreateRsp from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProjectSecretCreateRsp from a dict"""
        if obj is None:
            return None
