...
class TrackingBrowserStatsListRspAllOfData(BaseModel):
    """
    TrackingBrowserStatsListRspAllOfData
    """ # noqa: E501
    stats: List[TrackingBrowserStats]
    paging: Paging
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TrackingBrowserStatsListRspAllOfData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TrackingBrowserStatsListRspAllOfData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "stats": [TrackingBrowserStats.from_dict(_item) for _item in obj["stats"]] if obj.get("stats") is not None else None,
