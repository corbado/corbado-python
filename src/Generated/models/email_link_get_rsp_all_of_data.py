...
class EmailLinkGetRspAllOfData(BaseModel):
    """
    EmailLinkGetRspAllOfData
    """ # noqa: E501
    email_link: EmailLink = Field(alias="emailLink")
    __properties: ClassVar[List[str]] = ["emailLink"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EmailLinkGetRspAllOfData from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of email_link
        if self.email_link:
            _dict['emailLink'] = self.email_link.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EmailLinkGetRspAllOfData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "emailLink": EmailLink.from_dict(obj["emailLink"]) if obj.get("emailLink") is not None else None
        })
        return _obj
