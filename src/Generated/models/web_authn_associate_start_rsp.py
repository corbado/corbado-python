...
class WebAuthnAssociateStartRsp(BaseModel):
    """
    ...
    public_key_credential_creation_options: StrictStr = Field(description="Contains JSON payload data to start Passkeys (Biometrics) sign up challenge", alias="publicKeyCredentialCreationOptions")
    __properties: ClassVar[List[str]] = ["httpStatusCode", "message", "requestData", "runtime", "status", "publicKeyCredentialCreationOptions"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebAuthnAssociateStartRsp from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebAuthnAssociateStartRsp from a dict"""
        if obj is None:
            return None
