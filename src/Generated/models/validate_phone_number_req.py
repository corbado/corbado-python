...
class ValidatePhoneNumberReq(BaseModel):
    """
    ValidatePhoneNumberReq
    """ # noqa: E501
    region_code: Optional[StrictStr] = Field(default=None, description="ISO country or region code", alias="regionCode")
    phone_number: StrictStr = Field(description="Phone number to validate", alias="phoneNumber")
    ...
    __properties: ClassVar[List[str]] = ["regionCode", "phoneNumber", "requestID", "clientInfo"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ValidatePhoneNumberReq from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ValidatePhoneNumberReq from a dict"""
        if obj is None:
            return None
