...
class ProjectConfigApi:
    ...
    def project_activate(
        ...
        _param = self._project_activate_serialize(
            empty_req=empty_req,
    ...
    @validate_call
    def project_activate_with_http_info(
        self,
        empty_req: EmptyReq,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def project_activate_without_preload_content(
        self,
        empty_req: EmptyReq,
        _request_timeout: Union[
            None,
    ...
    def _project_activate_serialize(
        self,
        empty_req,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/v1/projects/activate',
    ...
    def project_config_get(
        ...
        _param = self._project_config_get_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def project_config_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ProjectConfigGetRsp]:
        """project_config_get
    ...
    @validate_call
    def project_config_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _project_config_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/projectConfig',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def project_config_save(
        self,
        project_config_save_req: ProjectConfigSaveReq,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param project_config_save_req: (required)
        :type project_config_save_req: ProjectConfigSaveReq
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._project_config_save_serialize(
            project_config_save_req=project_config_save_req,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def project_config_save_with_http_info(
        self,
        project_config_save_req: ProjectConfigSaveReq,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def project_config_save_without_preload_content(
        self,
        project_config_save_req: ProjectConfigSaveReq,
        _request_timeout: Union[
            None,
    ...
    def _project_config_save_serialize(
        self,
        project_config_save_req,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if project_config_save_req is not None:
            _body_params = project_config_save_req
    ...
    @validate_call
    def project_config_webhook_test(
        self,
        project_config_webhook_test_req: ProjectConfigWebhookTestReq,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        """project_config_webhook_test

        Tests webhook backend

        :param project_config_webhook_test_req: (required)
        :type project_config_webhook_test_req: ProjectConfigWebhookTestReq
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._project_config_webhook_test_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ProjectConfigWebhookTestRsp",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def project_config_webhook_test_with_http_info(
        self,
        project_config_webhook_test_req: ProjectConfigWebhookTestReq,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ProjectConfigWebhookTestRsp]:
        """project_config_webhook_test
    ...
    @validate_call
    def project_config_webhook_test_without_preload_content(
        self,
        project_config_webhook_test_req: ProjectConfigWebhookTestReq,
        _request_timeout: Union[
            None,
    ...
    def _project_config_webhook_test_serialize(
        self,
        project_config_webhook_test_req,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if project_config_webhook_test_req is not None:
            _body_params = project_config_webhook_test_req
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/v1/projectConfig/testWebhook',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
