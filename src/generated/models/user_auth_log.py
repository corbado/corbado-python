...
class UserAuthLog(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["userID", "userName", "method", "eventType", "status", "created"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserAuthLog from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserAuthLog from a dict"""
        if obj is None:
            return None
