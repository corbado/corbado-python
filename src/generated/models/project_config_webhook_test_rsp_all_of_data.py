...
class ProjectConfigWebhookTestRspAllOfData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["code", "details", "runtime"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProjectConfigWebhookTestRspAllOfData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProjectConfigWebhookTestRspAllOfData from a dict"""
        if obj is None:
            return None
