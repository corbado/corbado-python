...
class TrackingBackupState(BaseModel):
    """
    TrackingBackupState
    """ # noqa: E501
    backed_up: StrictInt = Field(alias="backedUp")
    not_backed_up: StrictInt = Field(alias="notBackedUp")
    __properties: ClassVar[List[str]] = ["backedUp", "notBackedUp"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TrackingBackupState from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TrackingBackupState from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "notBackedUp": obj.get("notBackedUp")
        })
        return _obj
