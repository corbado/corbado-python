...
class TrackingBrowserDetailedStats(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["timePoint", "browserName", "browserVersion", "cnt", "webauthn", "platform", "conditional_ui"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TrackingBrowserDetailedStats from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TrackingBrowserDetailedStats from a dict"""
        if obj is None:
            return None
