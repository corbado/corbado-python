...
class EmailCode(BaseModel):
    ...
    EmailCode
    """ # noqa: E501
    id: StrictStr = Field(description="ID of the email OTP", alias="ID")
    ...
    status: StrictStr = Field(description="status values of an email OTP")
    __properties: ClassVar[List[str]] = ["ID", "userID", "email", "userFullName", "additionalPayload", "created", "updated", "status"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EmailCode from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EmailCode from a dict"""
        if obj is None:
            return None
