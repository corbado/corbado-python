...
class EmailLinkSendRspAllOfData(BaseModel):
    """
    EmailLinkSendRspAllOfData
    """ # noqa: E501
    email_link_id: StrictStr = Field(alias="emailLinkID")
    __properties: ClassVar[List[str]] = ["emailLinkID"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EmailLinkSendRspAllOfData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EmailLinkSendRspAllOfData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "emailLinkID": obj.get("emailLinkID")
        })
        return _obj
