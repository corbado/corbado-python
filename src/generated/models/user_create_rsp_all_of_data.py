...
class UserCreateRspAllOfData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["userID", "emailID", "phoneNumberID"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserCreateRspAllOfData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserCreateRspAllOfData from a dict"""
        if obj is None:
            return None
