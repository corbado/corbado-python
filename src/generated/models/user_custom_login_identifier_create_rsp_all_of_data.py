...
class UserCustomLoginIdentifierCreateRspAllOfData(BaseModel):
    """
    UserCustomLoginIdentifierCreateRspAllOfData
    """ # noqa: E501
    custom_login_identifier_id: StrictStr = Field(alias="customLoginIdentifierID")
    __properties: ClassVar[List[str]] = ["customLoginIdentifierID"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserCustomLoginIdentifierCreateRspAllOfData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserCustomLoginIdentifierCreateRspAllOfData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "customLoginIdentifierID": obj.get("customLoginIdentifierID")
        })
        return _obj
